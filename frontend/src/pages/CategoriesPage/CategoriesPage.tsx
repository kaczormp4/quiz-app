  ...
  return (
    <>
      <Seo
        ...
        title="Interview and exam practice categories — ReadyWise"
        description="Choose a professional knowledge category and practice interview questions with clear explanations."
      />
